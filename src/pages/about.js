...
export default () => (
  ...
  >
    ...
    <section>
      ...
      <p>
        I am, so to speak, a <em>self-taught</em> software engineer. Having said
        that, I'm hesitant to describe myself as self-taught. The community
        around the art of building software is so supportive that I have always
        been able to learn from something or someone.
      </p>
      <p>
        it seems to me that every member of this community is not only a learner
    ...
    <section>
      ...
      <p>
        ...
        code to setup my own retail shop. Since then, writing code has become my
        major means of craftsmanship.
      </p>
      <p>
